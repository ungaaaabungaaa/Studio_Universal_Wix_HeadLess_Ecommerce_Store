      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-6">
          ...
          <div className=" p-6 rounded-lg shadow-md">
            ...
            <p className="mt-2">Once your order has been shipped, we will send you a tracking number via email. You can use this number to track your package through the carrier's website and monitor its progress. If you haven't received a tracking number, please contact us at [contact@braindstudio.com](mailto:contact@braindstudio.com).</p>
          </div>

          {/* Returns */}
          <div className=" p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold">5. What is your return policy?</h2>
            <p className="mt-2">We accept returns within 30 days of delivery. Items must be unworn, unused, and in their original packaging. To initiate a return, please contact us at [returns@braindstudio.com](mailto:returns@braindstudio.com) with your order number and reason for the return. We'll provide you with instructions on how to return your items.</p>
          </div>
